...
export default function Checkout() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    const lines = [
      "Halo, saya ingin beli produk n8n",
  "",
  `Nama: ${name}`,
  `Email: ${email}`,
  `WhatsApp: ${whatsapp}`,
  ...
  `Kupon: ${coupon ? coupon.toUpperCase() : "-"}`,
  `Diskon kupon: ${couponDiscount > 0 ? formatRupiah(couponDiscount) : "-"}`,
  `Total: ${formatRupiah(total)}`,
  "",
  "Info Pembayaran:",
  "Transfer ke salah satu bank:",
  "- BCA 629.0146.303 a.n. Fatkul Amri",
  "- Mandiri 144-00-1122645-0 a.n. Fatkul Amri",
  "",
  "Kirim bukti ke WA 081234-306725 atau email suratkita@gmail.com"
    ].filter(Boolean);
